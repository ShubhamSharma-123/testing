...
//   LayoutDashboard, Users, Clock, Calendar, DollarSign, 
//   TrendingUp, FileText, Shield, UserCheck, BarChart3, 
//   Settings, ChevronLeft, ChevronRight, Building, UserRound, 
//   ChevronDown, ChevronUp, Bell, PartyPopper, CalendarRange, Building2, 
// } from 'lucide-react';
// import { useAuth } from '../../contexts/AuthContext';
...
//   // ✅ FIXED: correct location extraction
...
//   const navigationItems = [
//     { icon: LayoutDashboard, label: 'Dashboard', path: `/${basePath}/dashboard`, roles: ['admin', 'hr', 'accountant', 'supervisor'] },
//     {
//       icon: UserRound,
//       label: 'HR',
//       roles: ['admin', 'hr'],
//       children: [
//         { icon: Users, label: 'Employees', path: `/${basePath}/employees`, roles: ['admin', 'hr'] },
//         { icon: Clock, label: 'Attendance', path: `/${basePath}/attendance`, roles: ['admin', 'hr'] },
//         { icon: Calendar, label: 'Leave', path: `/${basePath}/leave`, roles: ['admin', 'hr'] },
//         { icon: FileText, label: 'Documents', path: `/${basePath}/documents`, roles: ['admin', 'hr'] },
//         { icon: CalendarRange, label: 'Holidays', path: `/${basePath}/holiday`, roles: ['admin', 'hr'] },
//       ]
//     },
//     { icon: Clock, label: 'Attendance', path: `/${basePath}/my-attendance`, roles:['hr', 'accountant', 'supervisor'] },
//     { icon: Calendar, label: 'Leave', path: `/${basePath}/my-leave`, roles:['hr', 'accountant', 'supervisor'] },
//     { icon: DollarSign, label: 'Payroll', path: `/${basePath}/payroll`, roles: ['admin', 'accountant'] },
//     { icon: TrendingUp, label: 'Performance', path: `/${basePath}/performance`, roles: ['admin', 'hr'] },
//     { icon: Shield, label: 'Policies', path: `/${basePath}/policies`, roles: ['admin', 'hr'] },
//     { 
//       icon: UserCheck, 
//       label: 'Supervisor', 
//       roles: ['supervisor'],
//       children: [
//         { icon: Building2, label: 'Company', path: `/${basePath}/company`, roles:['supervisor'] },
//         { icon: Users, label: 'Employees', path: `/${basePath}/employees`, roles:['supervisor'] },
//         { icon: Clock, label: 'Attendance', path: `/${basePath}/attendance`, roles:['supervisor'] }
//       ]
//     },
//     { icon: PartyPopper, label: 'Events', path: `/${basePath}/event`, roles: ['admin', 'hr'] },
//     { icon: Bell, label: 'Notice Board', path: `/${basePath}/notices`, roles: ['admin', 'hr', 'accountant'] },
//     { icon: BarChart3, label: 'Reports', path: `/${basePath}/reports`, roles: ['admin', 'hr', 'accountant'] },
//     { icon: Settings, label: 'Settings', path: `/${basePath}/settings`, roles: ['admin'] },
//   ];
...
const Sidebar = ({ isCollapsed, onToggle }) => {
  ...
  // Normalize role (fallback to "admin" so items still show if user is not loaded yet)
  const role = (user?.role || "admin").toLowerCase();

  // 🔎 Debug log – check values in Netlify console
